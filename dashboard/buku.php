...
<div class="x_panel">
    ...
    <!-- Content -->
    <a class="btn btn-primary" href="?page=buku&act=insert"><i class="fa fa-plus"></i> Tambahkan Buku</a>
                            ...
                            <?php foreach($data->getBookData() as $rows) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-warning rounded" href="?page=buku&act=edit&id=<?= $rows["BukuID"] ?>"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
