...
<body class="img js-fullheight" style="background-image: url(assets/img/riaa.jpg.jfif);background-size: 1920px 960px;">
                        ...
                        <div class="text-primary">
                            <div class="card shadow-lg border- rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-">login menu</h3>
                                </div>
                                <div class="card-body">
                                    <?php
