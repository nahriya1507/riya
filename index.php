...
<body class="sb-nav-fixed class="img js-fullheight style="background-image: url(assets/img/bg.jpg); background-size:cover;">
    ...
    <div id="layoutSidenav">
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu bg-primary sb-sidenav-menu">
                    <div class="nav">
