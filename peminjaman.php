<h1 class="mt-4"><div class="card bg-white text-primary">Laporan Peminjaman Buku </h1>
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <a href="?page=peminjaman_tambah" class="btn btn-primary mb-2"><i class="fa fa-plus"></i>Tambah Peminjaman</a>
